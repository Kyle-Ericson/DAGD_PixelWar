...
public class MapLoader : MonoBehaviour
{
    ...
    {
        MapItem map = Collections.mapData[mapID];  // get the map from the library
    ...
    private Dictionary<Vector2, Tile> SpawnMap(MapItem map)
    {
        ...
        { // for each row in the grid...
            ...
            { // for each column in the grid...
                ...
                GameObject gl = Instantiate(objGridLine, new Vector3(worldPos.x, worldPos.y, gridLineOffsetZ), Quaternion.identity); // spawn the grid lines
